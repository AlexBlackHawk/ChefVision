...
class CameraAccessDeniedView extends StatelessWidget {
  const CameraAccessDeniedView({super.key});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              LocaleKeys.cameraAccessDenied.tr(),
            ...
            Text(
              LocaleKeys.cameraPermissionRequired.tr(),
              textAlign: TextAlign.center,
