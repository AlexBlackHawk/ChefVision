...
class DetectedProductsError extends StatelessWidget {
  const DetectedProductsError({super.key});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              LocaleKeys.failedToDetectProducts.tr(),
