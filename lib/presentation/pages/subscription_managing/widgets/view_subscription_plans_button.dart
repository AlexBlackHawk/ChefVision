...
class ViewSubscriptionPlansButton extends StatelessWidget {
  const ViewSubscriptionPlansButton({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ElevatedButton.icon(
        onPressed: () => context.go(subscriptionsPage.path),
        ...
        label: Text(
          LocaleKeys.viewSubscriptionPlans.tr(),
