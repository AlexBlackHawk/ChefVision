...
class GeneratingMealError extends StatelessWidget {
  const GeneratingMealError({super.key});
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            LocaleKeys.recipeGenerationFailed.tr(),
          ...
          Text(
            LocaleKeys.failedToGenerateRecipe.tr(),
